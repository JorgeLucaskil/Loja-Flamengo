...
function BoxItem() {
  return (
    <div className="Area-prod">
      ...
      <div className="box">
        <a href=""><img src={Camisa1} className="im-box"></img></a>
        ...
        <div className="box">
        <a href=""><img src={Camisa2} className="im-box"></img></a>
      ...
      <div className="box">
        <a href=""><img src={Camisa3} className="im-box"></img></a>
        ...
        {/*camisa 4*/}
      <div className="box">
<a href=""><img src={Camisa4} className="im-box"></img></a>
